...
int main()
{
	...
	// [2] 참조 타입 변환
	// 특징) 비트열을 재구성 하지 않고, '관점'만 바꾸는 것
	// 거의 쓸일 없지만, 포인터 타입 변환도 '참조 타입 변환' 동일한 룰을 따르니까 일석이조로 공부하자!
	{
		int a = 123456789; // 2의 보수
		float b = (float&)a; // 부동소수점(지수 + 유효숫자)
		cout << b << endl;
	...
	// - 땡깡 부리면(명ㅅ히적 요구) 해주긴 하는데, 말 안해도 '그냥' (암시적)으로 해주는지는 안정성 여부를 연관 있음
