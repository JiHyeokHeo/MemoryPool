...
//	//  StatInfo[] 주소 [ (200,20, 2) ] StatInfo[] StatInfo[] StatInfo[] StatInfo[] StatInfo[] ...
//	// monster_1[ 주소 ]
...
//	//  StatInfo[]  StatInfo[] 주소[] StatInfo[] StatInfo[] StatInfo[] ...
//	// monster_2[ 주소 ]
...
//	int numbers1[10] = { 1,2,3,4,5 }; // 설정한 애들은 설정한 값으로, 나머지 값들은 0으로 초기화
//	int numbers2[] = { 1,2,3,4,11,21414,124214, 1 }; // 데이터 개수만큼의 크기에 해당하는 배열로 만들어준다.
